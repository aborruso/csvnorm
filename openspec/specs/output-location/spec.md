...
The system SHALL create UTF-8 conversion temporary files in a system temp directory with auto-cleanup, while placing reject files in the output directory with overwriting.
...
#### Scenario: Reject file in output directory
- **WHEN** validation errors occur during processing
